...
(function(){
    ...
    */
    ...
    console.log( sum(function(v1,v2){ return v1+v2; }) );
    ...
    */
    ...
    console.log( subtraction(function(v1,v2){ return v1-v2; }) );

    console.log( 'O resultado da multiplicação é:' );
    console.log( multiplication(function(v1,v2){ return v1*v2; }) );

    console.log( 'O resultado da divisão é:' );
    console.log( division(function(v1,v2){ return v1/v2; }) );

    console.log( 'O resto da divisão é:' );
    console.log( mod(function(v1,v2){ return v1%v2; }) );
